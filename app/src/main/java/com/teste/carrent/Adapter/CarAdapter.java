package com.teste.carrent.Adapter;
...
public class CarAdapter extends RecyclerView.Adapter<CarAdapter.VehicleHolder> {

    private Context context;
    private ArrayList<Vehicle> vehicle;
    private onVehicleListener onVehicleListener;

    public CarAdapter(Context context, ArrayList<Vehicle> vehicle, onVehicleListener onVehicleListener){
